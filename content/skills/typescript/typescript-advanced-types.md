...
description_es: "Domina el sistema de tipos avanzados de TypeScript — generics, tipos condicionales, mapped types, template literals y utility types para aplicaciones type-safe."
